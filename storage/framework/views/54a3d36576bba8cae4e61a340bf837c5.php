    ...
    <script>
            ...
            $("#proses").dxButton({
                ...
                onClick: function(e) {
                    let alm = "";
                    if (select == 0) {
                        alm = "<?php echo e(url('/rpt_get_salesPanelAll')); ?>";
                    } else {
                        alm = "<?php echo e(url('/rpt_get_salesPanelperMonth')); ?>";
                    }
            ...
            $("#exportByDistrict").dxButton({
              ...
              onClick: async function(e) {
                const exportUrl = "<?php echo e(url('/report-customer-export')); ?>";
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Herd/crm-microapp/resources/views/backend/report/rpt_salesPs.blade.php ENDPATH**/ ?>