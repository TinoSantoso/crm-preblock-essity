...
<script src="<?php echo url('asset/js/backend/preblock_mcl_entry.js'); ?>"></script>
<script src="<?php echo url('asset/js/backend/preblock_mcl_list.js'); ?>"></script>
<script src="<?php echo url('asset/js/backend/preblock_mcl_export.js'); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Herd/crm-microapp/resources/views/backend/preblock/preblock_mcl.blade.php ENDPATH**/ ?>